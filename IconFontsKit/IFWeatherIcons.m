#import "IFWeatherIcons.h"

@implementation IFWeatherIcons

+ (NSURL *)fontFileURL
{
    return [[[NSBundle mainBundle] resourceURL] URLByAppendingPathComponent:@"weathericons-regular-webfont.ttf"];
}
